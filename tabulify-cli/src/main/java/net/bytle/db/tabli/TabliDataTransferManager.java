...
import net.bytle.db.flow.step.TargetArguments;
import net.bytle.db.flow.step.TargetPipelineSimple;
import net.bytle.db.flow.step.TransferArgumentProperty;
import net.bytle.db.gen.DataGenerator;
import net.bytle.db.gen.GenDataPath;
import net.bytle.db.gen.GenDataPathType;
import net.bytle.db.licence.LicenceProperties;
...
import static net.bytle.db.flow.step.TransferArgumentProperty.SOURCE_OPERATION;
import static net.bytle.db.flow.step.TransferArgumentProperty.values;
