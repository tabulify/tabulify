...
import static net.bytle.db.tabli.TabliWords.ATTRIBUTE_PROPERTY;
...
public class TabliConnectionAdd {
  ...
  public static List<DataPath> run(Tabular tabular, CliCommand childCommand) {
    ...
    // Main
    Path connectionVaultPath = tabular.getConnectionVault();
    ...
    try (ConnectionVault connectionVault = new ConnectionVault(tabular, connectionVaultPath)) {
      ...
      if (connection != null) {
        ...
        connection = Connection.createConnectionFromProviderOrDefault(tabular, connectionName, urlValue)
          ...
          .addVariable(SqlConnectionAttribute.DRIVER, driverValue);
      }
      connectionVault
        .add(connection)
        .flush();
