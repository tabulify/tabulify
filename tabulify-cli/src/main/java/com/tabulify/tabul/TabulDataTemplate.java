...
import net.bytle.template.flow.TemplateAttribute;
import net.bytle.template.flow.TemplateEngine;
import net.bytle.template.flow.TemplatePipelineStep;
...
import static net.bytle.template.flow.TemplateAttribute.TEMPLATE_ENGINE;
...
public class TabulDataTemplate {
  ...
  public static List<DataPath> run(Tabular tabular, CliCommand childCommand) {
    ...
    final DataUriNode sourceSelector = tabular.createDataUri(cliParser.getString(SOURCE_SELECTOR));
