  ...
  public static List<DataPath> run(Tabular tabular, CliCommand childCommand) {
    ...
    childCommand
      .setDescription(
        ...
        "",
        "For more control on the data generated, you can add the data resource generators (`*" + GeneratorMediaType.DATA_GEN.getExtension() + "`)",
      ...
      .addExample(
        "To load the table `D_TIME` with the data generation file `D_TIME" + GeneratorMediaType.DATA_GEN.getExtension() + "` present in the current directory:",
        CliUsage.CODE_BLOCK,
