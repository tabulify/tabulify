...
public class TabulXmlPrint {
  ...
  public static void run(CliCommand childCommand, String[] args) {

    childCommand.addArg(FILE_XML)
      .setDescription("A Xml file Uri");

    childCommand.addFlag(DTD_VALIDATION)
      .setDescription("DTD validation")
      .setDefaultValue(false);

    childCommand.addProperty(XSD_FILE)
    ...
    childCommand.addFlag(IGNORE_WS)
      .setDescription("Create element content whitespace nodes")
      .setDefaultValue(false)
    ;
    childCommand.addFlag(IGNORE_COMMENT)
      .setDescription("Create comment nodes")
      .setShortName("co")
      .setDefaultValue(false);

    childCommand.addFlag(CDATA_INTO_TEXT)
      .setDescription("put CDATA into Text nodes")
      .setShortName("cd")
      .setDefaultValue(false);

    childCommand.addFlag(CREATE_ENTITY_REF)
