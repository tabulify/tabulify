...
public class GraphQLListGuidCoercing implements Coercing<ListGuid, String> {

  private final JacksonMapperManager jacksonMapperManager;

  public GraphQLListGuidCoercing(JacksonMapperManager jacksonMapperManager) {
  ...
  private ListGuid parseInput(Object input) throws CoercingParseLiteralException {
    ...
    try {
      ...
      throw new CoercingParseLiteralException("The input value (" + string + ") is not a valid list guid", e);
    }
  }
