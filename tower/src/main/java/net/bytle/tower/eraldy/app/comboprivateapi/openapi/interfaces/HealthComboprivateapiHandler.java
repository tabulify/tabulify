...
public class HealthComboprivateapiHandler {

private static final Logger logger = LoggerFactory.getLogger(HealthComboprivateapiHandler.class);

private final HealthComboprivateapi api;

public HealthComboprivateapiHandler(HealthComboprivateapi api) {
this.api = api;
}
