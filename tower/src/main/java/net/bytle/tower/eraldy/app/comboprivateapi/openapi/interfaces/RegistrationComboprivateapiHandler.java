...
public class RegistrationComboprivateapiHandler {

private static final Logger logger = LoggerFactory.getLogger(RegistrationComboprivateapiHandler.class);

private final RegistrationComboprivateapi api;

public RegistrationComboprivateapiHandler(RegistrationComboprivateapi api) {
this.api = api;
}
