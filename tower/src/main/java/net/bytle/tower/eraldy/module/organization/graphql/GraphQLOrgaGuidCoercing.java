...
public class GraphQLOrgaGuidCoercing implements Coercing<OrgaGuid, String> {
  ...
  @Override
  public @Nullable OrgaGuid parseValue(@NotNull Object input, @NotNull GraphQLContext graphQLContext, @NotNull Locale locale) throws CoercingParseValueException {
    return this.parseInput(input);
  }

  private OrgaGuid parseInput(Object input) throws CoercingParseLiteralException {
