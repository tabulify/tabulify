...
public class UserComboprivateapiHandler {

private static final Logger logger = LoggerFactory.getLogger(UserComboprivateapiHandler.class);

private final UserComboprivateapi api;

public UserComboprivateapiHandler(UserComboprivateapi api) {
this.api = api;
}
