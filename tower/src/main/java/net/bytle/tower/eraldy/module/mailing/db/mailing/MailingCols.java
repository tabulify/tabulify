...
public enum MailingCols implements JdbcTableColumn {
  ...
  ROW_COUNT( MAILING_PREFIX + COLUMN_PART_SEP + "row_count"),
  ROW_SUCCESS_COUNT (MAILING_PREFIX + COLUMN_PART_SEP + "row_success_count"),
  ROW_EXECUTION_COUNT (MAILING_PREFIX + COLUMN_PART_SEP + "row_execution_count"),
