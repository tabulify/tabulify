...
public class ServiceComboprivateapiHandler {

private static final Logger logger = LoggerFactory.getLogger(ServiceComboprivateapiHandler.class);

private final ServiceComboprivateapi api;

public ServiceComboprivateapiHandler(ServiceComboprivateapi api) {
this.api = api;
}
