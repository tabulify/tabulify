...
public class ListImportManager {
  ...
  public ListImportManager(EraldyApiApp apiApp) {
    this.apiApp = apiApp;
    int sec10 = 10000;
  ...
  public String createAndGetJobId(ListItem list, FileUpload upload) throws TowerFailureException {
