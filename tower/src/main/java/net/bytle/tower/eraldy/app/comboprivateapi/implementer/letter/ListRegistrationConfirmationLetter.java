...
public class ListRegistrationConfirmationLetter {
  ...
  public ListRegistrationConfirmationLetter(HashMap<String,Object> data) {

    htmlTemplate = EraldyMemberApp.get().getTemplate(TEMPLATE_NAME);
    this.data = data;
  }
  ...
  public static class Config {
    ...
    public ListRegistrationConfirmationLetter build() {
      return new ListRegistrationConfirmationLetter(hashMap);
    }
