...
public class ListRegistrationFlow {
   ...
   */
  public static Future<Void> handleStep1SendingValidationEmail(RoutingContext routingContext, ListRegistrationPostBody publicationSubscriptionPost) {
   ...
   */
  public static Future<ApiResponse<String>> handleStep0RegistrationForm(RoutingContext routingContext, String listGuid) {
    ...
    return ListProvider.create(vertx)
      ...
      .compose(list -> {
        ...
        return FrontEndRouter.toPublicNonOAuthPage(routingContext, redirectUri);
   ...
   */
  public static Future<ApiResponse<String>> handleStep3Confirmation(RoutingContext routingContext, String registrationGuid) {
    return ListRegistrationProvider.create(routingContext.vertx())
      ...
      .compose(registration -> {
        ...
        return FrontEndRouter.toPrivatePage(routingContext, false);
      });
  }
}
