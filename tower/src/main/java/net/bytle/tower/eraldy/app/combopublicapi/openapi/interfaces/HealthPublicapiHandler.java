...
public class HealthPublicapiHandler {

private static final Logger logger = LoggerFactory.getLogger(HealthPublicapiHandler.class);

private final HealthPublicapi api;

public HealthPublicapiHandler(HealthPublicapi api) {
this.api = api;
}
