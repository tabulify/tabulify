...
import static net.bytle.tower.util.StaticResourcesUtil.ASSETS_PATH_OPERATION;
...
public abstract class TowerApp {
  ...
  public String getAbsoluteStaticResourcesPath() {
    return this.getAbsoluteLocalPathWithDomain() + ASSETS_PATH_OPERATION;
  }
   ...
   * This is used for custom handlers such as {@link OAuthExternal}
   ...
   * <p>
   * The public URI is saved hard core in external place such as {@link OAuthExternal oauth callback)
   * It is:
  ...
  private String getSuperToken() {
    ...
    return getConfig().getString(ApiTokenAuthenticationProvider.SUPERUSER_TOKEN_CONF);
