 ...
 * DropWizard
 */
public class HealthDropWizardHandlerFailure implements Handler<RoutingContext> {

  private final Counter validationErrorsCounter;
  private static final Logger logger = LoggerFactory.getLogger(HealthDropWizardHandlerFailure.class);

  public HealthDropWizardHandlerFailure() {
