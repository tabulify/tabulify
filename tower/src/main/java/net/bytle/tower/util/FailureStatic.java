...
public class FailureStatic {
   ...
   * the best is to throw an exception that is caught {@link ContextFailureHandler}
   * <p>
  ...
  public static void failRoutingContextWithTrace(Throwable throwable, RoutingContext routingContext) {
    ContextFailureHandler.failRoutingContextWithTrace(throwable, routingContext, null);
  }
}
