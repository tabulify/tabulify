...
comment on column cs_jobs.realm_mailing_job.MAILING_JOB_COUNT_SMTP_SUCCESS is 'The number of email send successfully (ie successful smtp transaction)';
comment on column cs_jobs.realm_mailing_job.MAILING_JOB_COUNT_SMTP_EXECUTION is 'The number of smtp transaction execution (successful or not)';
comment on column cs_jobs.realm_mailing_job.MAILING_JOB_COUNT_EMAIL_TO_SEND is 'The number of email to send';
