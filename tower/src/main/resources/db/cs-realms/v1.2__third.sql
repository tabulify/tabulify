...
alter table realm_app
  drop constraint realm_app_app_realm_id_app_user_id_fkey;
alter table realm_app
  add column app_orga_id BIGINT;
update realm_app
set app_orga_id = 1;
alter table realm_app
  alter column app_orga_id set not null;
alter table realm_app
...
alter table realm_list
  drop constraint realm_list_list_realm_id_list_owner_user_id_fkey;
alter table realm_list
  add column list_orga_id BIGINT;
...
alter table realm_user
  rename user_email to user_email_address;
-- drop disabled for status
alter table realm_user
  DROP user_disabled;
alter table realm_user
  add column user_status int not null default 0;
