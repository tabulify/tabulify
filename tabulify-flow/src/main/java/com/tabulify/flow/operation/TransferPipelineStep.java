...
public class TransferPipelineStep extends PipelineStepBuilderTarget {
  ...
  public PipelineStep build() {
     ...
     */
    templateUriFunction = TemplateUriFunction
      .builder(getTabular())
  ...
  public TransferPipelineStep addTransferListeners(List<TransferListener> transferListeners) {
   ...
   */
  public TransferPipelineStep injectTransferListenersReference(List<TransferListener> transferListeners) {
  ...
  public List<TransferListener> getAllTransfersListeners() {
    return allTransfersListeners;
  }
  ...
  List<DataPath> apply(List<DataPath> sourceDataPathList) {
    ...
    addTransferListeners(transferListeners);
    ...
    switch (getTransferOutput()) {
      ...
      case INPUTS:
        return sourceTargets.stream()
          ...
          .collect(Collectors.toList());
      default:
        return List.of(Transfers.transfersListenersToDataPath(this.getTabular(), getAllTransfersListeners()));
    }
  }
