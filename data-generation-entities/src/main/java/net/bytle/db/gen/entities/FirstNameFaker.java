 ...
 * for each local
 */
public class FirstNameFaker extends FakerBase {

  public static void main(String[] args) {

    new FirstNameFaker(EntitiesProperties.FIRSTNAME).generate();

  }

  public FirstNameFaker(String entity) {
    super(entity);
  }
