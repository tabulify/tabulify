 ...
 * for each local
 */
public class LastNameFaker extends FakerBase {

  public static void main(String[] args) {

    new LastNameFaker(EntitiesProperties.LASTNAME).generate();

  }

  public LastNameFaker(String entity) {
    super(entity);
  }
