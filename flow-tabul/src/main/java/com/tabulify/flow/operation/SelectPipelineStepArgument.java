...
public enum SelectPipelineStepArgument implements ArgumentEnum {
    ...
    DATA_DEF("The data definition", null, Map.class),
    ...
    public static SelectPipelineStepArgument cast(KeyNormalizer key) throws CastException {

        if (key.equals(KeyNormalizer.createSafe("data-attributes"))) {
            return DATA_DEF;
        }
        return Casts.cast(key, SelectPipelineStepArgument.class);
    }
