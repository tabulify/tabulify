...
public class OpenApiService extends TowerService {
  ...
  public OpenApiService(OpenApiInstance openApiInstance) {
     ...
     */
    String tempRelativeOpenApiResourceSpecFile = OPEN_API_RESOURCES_PREFIX + "/" + towerApp.getApexDomain().getFileSystemPathName().toLowerCase() + "/" + towerApp.getAppHandle().toLowerCase() + OPENAPI_YAML_PATH;
