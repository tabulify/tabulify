...
public class OpenApiService extends TowerService {
  ...
  private boolean requireSecurityHandlers = true;

  public OpenApiService(Builder builder) {


    towerApp = builder.towerApp;

    /**
     * A service to {@link #mount} on the router
     */
    towerApp.getHttpServer().getServer().registerService(this);
  ...
  public static Builder config(TowerApp towerApp) {
    return new Builder(towerApp);
  }
  ...
  public static class Builder {
    ...
    public Builder(TowerApp towerApp) {
  ...
  public Future<Void> mount() {
    ...
    Router rootRouter = this.towerApp.getHttpServer().getRouter();
