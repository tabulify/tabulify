...
public class OpenApiUtil {
  ...
  public static class config {
    ...
    public OpenApiUtil build() {
      ...
      /**
       * The openapi.yaml file is generated by the OpenApi Generator
       * The source files are known as combo-xxxx-openapi.yaml
       */
      String specFile = towerApp.getRelativeSpecFileResourcesPath();

      if (!Javas.getSourceCodePathInJar(OpenApiUtil.class)) {
        specFile = "src/main/resources/" + specFile;
      }
      OpenApiUtil comboOpenBuilder = new OpenApiUtil();
      comboOpenBuilder.specFile = URI.create(specFile);
