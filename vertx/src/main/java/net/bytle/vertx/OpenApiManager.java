...
public class OpenApiManager {
  ...
  public OpenApiManager(config config) {
     ...
     */
    String resourceSpecFile = config.towerApp.getRelativeSpecFileResourcesPath();
    ...
    specFile = URI.create(resourceSpecFile);
    towerApp = config.towerApp;
  ...
  public static class config {
    ...
    public OpenApiManager build() {
      ...
      return new OpenApiManager(this);
