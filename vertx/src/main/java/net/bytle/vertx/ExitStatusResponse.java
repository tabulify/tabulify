...
/**
 * A response with a status code and status message  Example of error on Github:
 * <pre>
 * {@code
 * {
 ...
 * </pre>
 * <p>
 * Example of error in Google hitting <a href="https://www.googleapis.com/oauth2/v1/userinfo">...</a>
 * <pre>
 * {@code
 *  {
 *  "error": {
