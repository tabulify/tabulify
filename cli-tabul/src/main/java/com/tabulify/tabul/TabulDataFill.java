  ...
  public static List<DataPath> run(Tabular tabular, CliCommand childCommand) {
    ...
    childCommand
      .setDescription(
        ...
        "",
        "For more control on the data generated, you can add the data resource generators (`*" + GeneratorMediaType.FS_GENERATOR_TYPE.getExtension() + "`)",
        ...
        "",
        "The default transfer operation is `" + TabulDataTransferManager.DEFAULT_FILL_TRANSFER_OPERATION + "`."
      )
      .addExample(
      ...
      .addExample(
        "To load the table `D_TIME` with the data generation file `D_TIME" + GeneratorMediaType.FS_GENERATOR_TYPE.getExtension() + "` present in the current directory:",
        CliUsage.CODE_BLOCK,
    ...
    return TabulDataTransferManager.config(tabular, childCommand, null, TabulDataTransferCommandType.FILL)
      .build()
      .run();
