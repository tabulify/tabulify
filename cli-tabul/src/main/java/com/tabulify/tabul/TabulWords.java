...
public class TabulWords {
  ...
  static final String PROCESSING_TYPE_OPTION = CliParser.PREFIX_LONG_OPTION + KeyNormalizer.createSafe(TransferPipelineStepArgument.PROCESSING_TYPE).toCliLongOptionName();
