 ...
 * This class is used by the {@link DocExecutorUnit#eval(DocUnit)} function
 * when compiling to represent the Java source code in a string in place of in a file
 * Therefore no file is created.
 */
public class DocSource extends SimpleJavaFileObject {
     ...
     */
    DocSource(String name, String code) {
