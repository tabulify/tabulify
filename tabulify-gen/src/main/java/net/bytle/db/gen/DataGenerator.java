...
import net.bytle.db.gen.generator.ForeignColumnGenerator;
 ...
 * <p>
 * This class also:
 * * give context to a data generation builder - help build the data generation (give context, a {@link net.bytle.db.gen.generator.ExpressionGenerator} need to of access to the other data generations)
...
public class DataGenerator implements AutoCloseable {
  ...
  public DataGenerator addTransfer(GenDataPath sourceDataPath, DataPath targetDataPath) {
    ...
    if (sourceDataPath instanceof GenMemDataPath) {
      ...
      /**
       * This is a {@link net.bytle.db.gen.fs.GenFsDataPath}
