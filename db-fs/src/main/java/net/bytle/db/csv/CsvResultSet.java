...
public class CsvResultSet implements ResultSet {
    ...
    public CsvResultSet(Path path) {
        ...
        try {
            ...
            resultMetadata = new ResultSetMetaDataCsv(csvRecord);
    ...
    public Object getObject(int columnIndex) throws SQLException {
        return csvRecord.get(columnIndex - 1);
    }
    ...
    private class ResultSetMetaDataCsv implements ResultSetMetaData {

        CSVRecord csvRecord;

        public ResultSetMetaDataCsv(CSVRecord csvRecord) {
