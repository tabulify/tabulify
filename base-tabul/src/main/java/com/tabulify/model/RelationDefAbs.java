...
public abstract class RelationDefAbs implements RelationDef {
  ...
  public ForeignKeyDef foreignKeyOf(PrimaryKeyDef primaryKeyDef, String... columnNames) {
    ...
    if (primaryKeyDef == null) {
      throw new InternalException("To add a foreign key to (" + this.getDataPath().toString() + ") on the columns (" + Arrays.toString(columnNames) + "), the primary key should not be null");
    }
