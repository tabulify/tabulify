...
public class TransferSourceTargetOrder {
  ...
  public static final Log LOGGER = Logs.createFromClazz(TransferSourceTargetOrder.class);
  ...
  public void targetPreOperationsAndCheck(TransferListener transferListener, boolean createTarget) {
    ...
    /**
     * Empty check (Target should be empty for a copy, move operation if there is no truncate, drop)
     */
    if (
