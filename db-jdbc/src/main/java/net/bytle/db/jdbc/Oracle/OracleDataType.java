 ...
 * http://docs.oracle.com/cd/E11882_01/appdev.112/e13995/constant-values.html#oracle_jdbc_OracleTypes_BINARY_DOUBLE
 *
 * Data Type Mapping
 * Database JDBC Developer's Guide and Reference
 * http://docs.oracle.com/cd/B28359_01/java.111/b31224/datacc.htm#i1008338
 *
 * List of SQL Data Type
 * In most cases the standard Java types are preferred to the vendor data types
 *
 */
public abstract class OracleDataType  {
...
//    INTERVALDS(OracleTypes.INTERVALDS, JdbcDataType.DATE.getDataTypeCategory(), null, oracle.sql.INTERVALDS.class, "INTERVALDS", false, false ),
//    INTERVALYM(OracleTypes.INTERVALYM, JdbcDataType.DATE.getDataTypeCategory(), null, oracle.sql.INTERVALYM.class, "INTERVALYM", false, false );
