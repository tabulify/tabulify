...
public class DataGenerator implements AutoCloseable {
   ...
   */
  public GenMemDataPath toGenMemDataPath(DataPath dataPath, DataPath targetDataPath) {
    ...
    if ((dataPath instanceof FsDataPath && targetDataPath == null) || targetDataPath instanceof FsDataPath) {
       ...
       * and has of now, we can't insert in it
       */
    ...
    return (GenMemDataPath) this.memoryConnection
      .getTypedDataPath(GeneratorMediaType.DATA_GEN, name)
  ...
  public DataGenerator load() {
    ...
    TransferManager transferManager = TransferManager
      .builder()
      .setTransferPropertiesSystem(this.transferProperty).build();
    ...
    this.transferResult = transferManager.createOrder(transferSourceTargetList).execute();
  ...
  public DataGenerator generateSourceTargetMap() {
    ...
    for (GenMemDataPath sourceDataPath : targetSources.values()) {
      sourceDataPath
        .getGenDataPathUtility()
  ...
  public DataGenerator addTransfer(GenDataPath sourceDataPath, DataPath targetDataPath) {
    ...
    if (sourceDataPath instanceof GenMemDataPath) {
      ...
      /**
       * This is a {@link GenManifestDataPath}
       ...
       */
      sourceGenMemDataPath = toGenMemDataPath(sourceDataPath, targetDataPath);
    }
  ...
  public GenMemDataPath createGenDataPath(String name) {
    return (GenMemDataPath) this.memoryConnection.getTypedDataPath(GeneratorMediaType.DATA_GEN, name);
  }
  ...
  public DataGenerator setTransferProperty(TransferPropertiesSystem.TransferPropertiesSystemBuilder transferPropertiesSystemBuilder) {
