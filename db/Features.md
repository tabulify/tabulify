...
ClientName has started collecting anonymous usage analytics to help improve ClientName for all users.
If you'd like to opt-out, you can use `ClientName telemetry --disable`   
