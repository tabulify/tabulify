...
import static net.bytle.db.fs.textfile.FsTextDataPathAttributes.DEFAULTS.EOLS;
...
public class FsTextInsertStream extends InsertStreamAbs implements InsertStream {
  ...
  public void close() {
    ...
    /**
     * During the transfer {@link net.bytle.db.transfer.TransferManager#beforeTargetCreationAndPreOperations(TransferSourceTarget, TransferListener)}
     * may add columns
     *
     * We correct it here
     *
