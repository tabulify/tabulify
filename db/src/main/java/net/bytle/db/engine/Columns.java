...
public class Columns {
    ...
    public static <T> T getMin(ColumnDef<T> columnDef){
        return columnDef.getRelationDef().getDataPath().getDataStore().getDataSystem().getProcessingEngine().getMin(columnDef);
    }

    public static <T> T getMax(ColumnDef<T> columnDef) {
        return columnDef.getRelationDef().getDataPath().getDataStore().getDataSystem().getProcessingEngine().getMax(columnDef);
    }
