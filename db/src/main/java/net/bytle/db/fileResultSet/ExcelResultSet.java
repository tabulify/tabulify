...
public class ExcelResultSet implements ResultSet {
     ...
     */
    public ExcelResultSet(Path path, boolean headerPresent, String sheetName) {
        ...
        try {
            if (path.getFileSystem().provider().getScheme().equals("file")) {
                ...
                this.pkg = OPCPackage.open(path.toString());
    ...
    public String getString(int columnIndex) {
        ...
        return getString(physicalRowIndex, columnIndex);
    ...
    * It is used by all cell operations such as read and updates
    ...
    public Double getNumeric(int columnIndex) {
        ...
        validateCell(logicalRowIndex, columnIndex);
        return getNumeric(getPhysicalRowIndex(logicalRowIndex), columnIndex);
    ...
    public boolean getBoolean(int columnIndex) {
        ...
        validateCell(logicalRowIndex, columnIndex);
        return getBoolean(getPhysicalRowIndex(logicalRowIndex), columnIndex);
    ...
    public Date getDate(int columnIndex) {
        ...
        validateCell(logicalRowIndex, columnIndex);
        int physicalRowIndex = getPhysicalRowIndex(logicalRowIndex);
        return getDate(physicalRowIndex, columnIndex);
...
//    }
    ...
    /**
     * Create the header for a new result set
     *
     * @param headerNames
     */
    void createHeaders(List<String> headerNames) {
        ...
        for (int i = 0; i < headerNames.size(); i++) {
            ...
            this.headerNames.put(headerName, columnIndex);
    ...
    * from the logical rowIndex
    ...
    public String getString(int rowIndex, int columnIndex) {
        ...
        int sheetRowIndex = this.getExcelRowIndex(rowIndex);
        ...
        if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
            ...
            throw new RuntimeException("The cell with the Excel coordinates (" + sheetRowIndex + "," + sheetColumnIndex + ") is not of type string but of type" + getCellTypeName(cell.getCellType()));
        }
    ...
    public Double getNumeric(int rowIndex, int columnIndex) {
        ...
        if (cell.getCellType() == Cell.CELL_TYPE_NUMERIC) {
            ...
            throw new RuntimeException("The cell with the Excel coordinates (" + sheetRowIndex + "," + sheetColumnIndex + ") is not of type NUMERIC but of type" + getCellTypeName(cell.getCellType()));
        }
    }
    ...
    public boolean getBoolean(int rowIndex, int columnIndex) {
        ...
        throw new RuntimeException("The cell with the Excel coordinates (" + sheetRowIndex + "," + sheetColumnIndex + ") is not of type BOOLEAN but of type " + getCellTypeName(cell.getCellType()));
    ...
    public Date getDate(int rowIndex, int columnIndex) {
        ...
        if (cell.getCellType() == Cell.CELL_TYPE_NUMERIC) {
            ...
            throw new RuntimeException("The cell with the Excel coordinates (" + sheetRowIndex + "," + sheetColumnIndex + ") with the value (" + getCellValue(cell) + ") is not of type NUMERIC (needed for a Date) but of type (" + getCellTypeName(cell.getCellType()) + ")");
        }
