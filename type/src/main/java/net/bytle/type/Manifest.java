...
public class Manifest {
   ...
   */
  public Manifest(Class<?> aClazz) throws NoManifestException {
  ...
  public static Manifest createFor(Class<?> aClazz) throws NoManifestException {
    return new Manifest(aClazz);
  }


  public String getAttribute(Attribute manifestAttribute) throws NoValueException {
